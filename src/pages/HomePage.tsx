...
import { ArrowRight, CheckCircle, Package, Truck, Shield, Zap } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Industry-leading conduit pipes and accessories. From residential installations to large-scale industrial projects.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-[#FFB400] rounded-lg flex items-center justify-center mb-4">
                <Package className="w-6 h-6 text-[#1A2A44]" />
              </div>
              <h3 className="text-lg font-semibold text-[#1A2A44] mb-2">Wide Selection</h3>
              <p className="text-gray-600 text-sm">Extensive range of conduit pipes and accessories for all applications</p>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-[#FFB400] rounded-lg flex items-center justify-center mb-4">
                <Shield className="w-6 h-6 text-[#1A2A44]" />
              </div>
              <h3 className="text-lg font-semibold text-[#1A2A44] mb-2">Quality Assured</h3>
              <p className="text-gray-600 text-sm">All products meet international standards and certifications</p>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-[#FFB400] rounded-lg flex items-center justify-center mb-4">
                <Truck className="w-6 h-6 text-[#1A2A44]" />
              </div>
              <h3 className="text-lg font-semibold text-[#1A2A44] mb-2">Fast Delivery</h3>
              <p className="text-gray-600 text-sm">Reliable shipping with tracking for all orders</p>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-[#FFB400] rounded-lg flex items-center justify-center mb-4">
                <Zap className="w-6 h-6 text-[#1A2A44]" />
              </div>
              <h3 className="text-lg font-semibold text-[#1A2A44] mb-2">Bulk Discounts</h3>
              <p className="text-gray-600 text-sm">Special pricing for contractors and large orders</p>
            </div>
          </div>
        </div>
      </section>
